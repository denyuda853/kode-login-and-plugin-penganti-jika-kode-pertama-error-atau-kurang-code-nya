                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: const Color.fromARGB(255, 214, 214, 214).withOpacity(.2)),
                    child: TextFormField(
                      controller: username,
                      validator: (value) {
                        if (value!.isEmpty) {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        color: const Color.fromARGB(255, 231, 231, 231).withOpacity(.2)),
                    child: TextFormField(
                      controller: password,
                      validator: (value) {
                        if (value!.isEmpty) {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        color: const Color.fromARGB(255, 248, 248, 248).withOpacity(.2)),
                    child: TextFormField(
